...
import './BestESDBreedsAnxiety.css';
import DOMPurify from 'dompurify'; 
export default class BestESDBreedsAnxiety extends Component {
    render() {
         if(this.props.myloading){
        return (
            <>
                         
                <section className='BestESDBreedsAnxietyWrap'> 
                    <Container fluid className='px-3 px-md-5'> 
                        <Row className='align-items-center justify-content-center'>
                            <Col xs={12}  lg={12} xl={12} className='text-center'> 
                                <h3 className="h2 text-uppercase pb-2">{this.props.Besda.besdbheading} </h3>  
                            </Col>
                            <Tabs>
                            <Col xs={12} className="DogBreedsTabs"> 
                                <Row>
                                    <Col xs={12} lg={12} xl={12}> 
                                        <TabList>
                                             {this.props.Besda.besdbtabsbx.map((tablist,index) => (  
                                    ...
                                    {this.props.Besda.besdbtabcontentbx.map((tabcnt,index) => (  
